...
# https://www.kaggle.com/lscoelho/facebook-v-predicting-check-ins/modified-grid-knn/run/282976/code
    ...
    for i in range(x_cuts):
        ...
        for j in range(y_cuts):
            ...
            for t in range(t_cuts):
                ...
                print "cell_pred shape", cell_pred.shape
...
def generate_submission(preds):    
    ...
    with open('KNN_submission_scripts1.csv', "w") as out:
...
val_start_day = 450 #0 # Day at which to cut validation
...
# Commented t_cuts and n_neighbor 