...
# https://www.kaggle.com/zeroblue/facebook-v-predicting-check-ins/modified-grid-knn-17-alex2/discussion
        ...
        for j in range(y_cuts):
            ...
            for t in range(t_cuts):
                ...
                cell_pred = process_one_cell(cell_train, cell_test, 
                                             fw, th)
                print x_min, x_max, y_min, y_max, cell_train.shape, cell_test.shape, cell_pred.shape
